...
const Navbar = () => {
    ...
    return (
        <div className='fixed z-50 max-w-[1441px] mx-auto mt-[26px] max-md:mt-0 w-full'>
            <div className='relative w-full max-lg:px-[10px] max-lg:justify-between min-h-[77px] mx-[36px] max-md:mx-0 flex rounded-lg max-md:rounded-t-none max-md:rounded-b-lg 
            max-425:!min-h-[67px]'>
                    <a href="/dashboard">
                        <div style={{
                ...
                <div className='max-lg:hidden w-[77px] flex-shrink-0 ml-[12px] flex items-center justify-center cursor-pointer hover:brightness-90 transition-all duration-200 ease-in-out'>
                    <div onClick={logout} className='rounded-[18px] h-[77px] w-[77px] bg-[#A63D3D] flex items-center justify-center'>
